      ...
      <div class="left">
        ...
        <ul class="right">
          ...
          <router-link class="px16 pointer" to='/release' tag='li' replace>
            <span  @click="xxx">发布</span>
          </router-link>
          <router-link class="px16 pointer" to='/car' tag='li' replace >
            <span @click="xx">购买</span>
          </router-link>
<!--          <router-link class="px16 pointer" style="cursor:help" to='/help' tag='li' replace><span>帮助</span></router-link>-->
          <router-link class="px16 pointer" style="cursor:help" to='/question1' tag='li' replace><span>问卷1</span></router-link>
          <router-link class="px16 pointer" style="cursor:help" to='/question2' tag='li' replace><span>问卷2</span></router-link>
          <router-link class="px16 pointer" style="cursor:help" to='/question3' tag='li' replace><span>问卷3</span></router-link>
          <router-link class="px16 pointer" style="cursor:help" to='/question4' tag='li' replace><span>问卷4</span></router-link>
          <router-link class="px16 pointer" style="cursor:help" to='/question5' tag='li' replace><span>问卷5</span></router-link>
          <router-link class="px16 pointer" style="cursor:help" to='/AI' tag='li' replace><span>聊天机器人</span></router-link>
        </ul>
      </div>
        ...
        <div class="px14" v-if="$store.state.img" style="padding-top: 20px">
         ...
         {{$store.state.name}}<i class="el-icon-arrow-down el-icon--right"></i>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="d">我的余额</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
