...
<!--        </div>-->
        <el-card :body-style="{ padding: '0px' }" style="margin-left: 200px">
          ...
          <div style="padding: 14px;">
            ...
            <p><a href="/home">Go for a casual stroll</a><span>,See if there is anything you like</span></p>
          </div>
        </el-card>
      </div>
      <div class="GoodsBd" v-else>
        <p style="font-size: 20px;color: #0DA5DD">Product purchases, will show you the products you have purchased, you have purchased a total of{{collect.length}}The product of your choice</p>
        <div style="margin-top: 20px" class="single xx"
          ...
          <ul>
            ...
            <li class="clear">
              <p>
                <!-- 时间 -->
                <span class="item" style="padding-left: 8px">Purchase Time:{{car[index].createTime.substring(0,10)}}</span>
                <!-- 收藏次数  浏览次数 点击收藏 -->
              </p>
            </li>
            <li>
              ...
              <div style="float: right">
                <el-button  type="danger" @click="hover(car[index].id)">删除记录</el-button>
              </div>
            </li>
          </ul>
        </div>
            ...
            <div class="clearfix">
              ...
              <div class="right">
                <ul>
                  ...
                  <li>
                    <span>购买人数:<span style="color: red"> {{datas.sc}}</span></span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      hover(id) {
        this.$confirm('是否不再保留此商品的购买记录?', '提示', {
